...
<body>
    ...
    <div class="header_nav_bg">
        ...
        <?php
        if (isset($_GET['error']) && $_GET['error'] === 'pay_user_not_found') {
            echo '<div class="error_message" id="error_pay"><span>Потрібен обліковий запис!
            <center><a href="#" id="link_error_message_pay">Ок</a></span></center></div>';
        }
        ?>
    ...
    <div class="main_container">
        <div class="left_content">
            ...
            <a class="game_ref" href="/course_game_shop-main/games_info/witcher3/witcher3.php">
                <img src="/course_game_shop-main/pictures/witcher3_main.png" alt=""> <br>
                <span>The Witcher 3: Wild Hunt</span>
            </a>
            <a class="game_ref" href="./games_info/witcher3/witcher3.php">
                <img src="/course_game_shop-main/pictures/witcher2_main.png" alt=""> <br>
    ...
    <div class="footer_bg">
        <div class="footer">
            <ul class="footer_list">
                <li>
                    <a href="https://t.me/Ruslan_perep">Зв'язатися з Перепом</a>
                </li>
                <li>
    ...
    <script src="/course_game_shop-main/js/error_pay.js"></script>
    <script src="/course_game_shop-main/js/search.js"></script>
</body>
