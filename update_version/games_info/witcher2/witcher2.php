...
<body>
        ...
        <div class="pay_form">
            ...
            <form action="" method="post">
                <div style="padding: 7px 4px 2px 4px;">
                    <label for="number">Номер карти (16 цифр):</label>
                </div>
                <input type="text" name="number" id="number" maxlength="16" pattern="[0-9]{16}" required>

                <div style="padding: 7px 4px 2px 4px;">
                    <label for="term">Термін дії (ММ/РР):</label>
                </div>
                <input type="text" name="term" pattern="(1[0-2]|0[1-9])/[2][3-9]" maxlength="5" required>

                <div style="padding: 7px 4px 2px 4px;">
                    <label for="pass">CVC (3 цифри):</label>
                </div>
                <input type="password" name="pass" pattern="[0-9]{3}" maxlength="3" required>
    ...
    <div class="main_container">
        <div class="left_content left_content_game_info">
            <div class="infonew">The Witcher 2 (Відьмак 2)</div>
