...
<body>
    ...
    <div class="main_container">
        <div class="left_content">
            ...
            <span class="left_content_span">Логін: <?= $_COOKIE['cookieLogin']?></span>
            <?php if($_COOKIE['witcher_key']):?>
            <span class="left_content_span">Ваш ключ до The Witcher 3: Wild Hunt: <?= $_COOKIE['witcher_key']?></span>
            <?php endif; ?>
        </div>
